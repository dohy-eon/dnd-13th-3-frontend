  ...
  return (
    <div className='fixed bottom-0 left-0 right-0 z-[9999] pb-safe-area-inset-bottom'>
      <div className='max-w-[288px] mx-auto pb-4'>
        <div className='w-full bg-white rounded-[32px] outline outline-1 outline-offset-[-1px] outline-gray-200 inline-flex justify-center items-center shadow-lg'>
          <button
            type='button'
            onClick={() => router.push("/challenge")}
            aria-current={isChallengeActive ? "page" : undefined}
            className='h-16 px-8 py-2.5 inline-flex flex-col justify-center items-center gap-0.5'
          >
            <Image
              src={
                isChallengeActive
